...
export class DraftService {
  ...
  public startDraft() {
    return this.http.post(DraftService.startURL, {},
  ...
  public endDraft() {
    return this.http.post<{ message: string, reward: Rewards }>(DraftService.endURL,
  ...
  public saveDraftData() {
    return this.http.post(DraftService.updateURL,
      { draftData: this.currentDraft.toSavable() },
      { headers: this.auth.getAuthHeader() })
  ...
  public getServerDraft(): Promise<Draft> {
    return this.http.get<{ message: string, draftData: SavedDraft }>(DraftService.getURL,
      { headers: this.auth.getAuthHeader() })
      .toPromise()
      .then(resp => {
